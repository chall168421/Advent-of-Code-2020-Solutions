...
def solve2(data):
    ...
    for i in range(data.count("jmp")):
        variants.append(replacenth(data, "jmp", "nop", i))
    
    for i in range(data.count("nop")):
        variants.append(replacenth(data, "nop", "jmp", i))
    ...
    while infinite_loop:
        ...
        acc, infinite_loop = solve(data.split("\n"))
        v += 1
